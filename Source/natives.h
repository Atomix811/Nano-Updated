...
namespace PED
{
	...
	static void SET_PED_MOVEMENT_CLIPSET(Player* player, char* clipSet, float blendTime) { invoke<Void>(0xAF8A94EDE7712BEF, player, clipSet, blendTime); } // 0xAF8A94EDE7712BEF 0xA817CDEB
...
namespace VEHICLE
{
	static Vehicle CREATE_CAR(Hash modelHash, float x, float y, float z, float heading, BOOL isNetwork, BOOL thisScriptCheck) { return invoke<Vehicle>(0xAF35D0D2583051B0, modelHash, x, y, z, heading, isNetwork, thisScriptCheck); } // 0xAF35D0D2583051B0 0xDD75460A
...
namespace GRAPHICS
{
	...
	static void DRAW_SPRITE2(char* textureDict, char* textureName, float screenX, float screenY, float width, float height, float heading, HANDLE hStdOut, int alpha) {invoke<Void>(0xE7FFAE5EBF23D890, textureDict, textureName, screenX, screenY, width, height, heading, hStdOut, alpha);} // 0xE7FFAE5EBF23D890 0x1FEC16B0
...
namespace UNK3
{
	...
	//static BOOL _NETWORK_SHOP_BEGIN_SERVICE2(Any* p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<BOOL>(0x3C5FD37B5499582E, p0, p1, p2, p3, p4, p5); } // 0x3C5FD37B5499582E
	static BOOL _NETWORK_SHOP_BEGIN_SERVICE3(Any* transactionID, Hash p1, Hash transactionHash, Any amount, Hash p4, Any mode) { return invoke<BOOL>(0x3C5FD37B5499582E, transactionID, p1, transactionHash, amount, p4, mode); } // 0x3C5FD37B5499582E
